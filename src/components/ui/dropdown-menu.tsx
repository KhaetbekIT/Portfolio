		...
		<DropdownMenuPrimitive.Portal>
			<DropdownMenuPrimitive.Content
				...
				className={cn(
					...
					"rounded-(--radius-md) border border-border p-1 shadow-md",
					className,
				)}
				{...props}
			/>
	...
	return (
		<DropdownMenuPrimitive.Item
			...
			className={cn(
				...
				"data-[variant=destructive]:focus:bg-[var(--destructive)/0.1]",
...
function DropdownMenuCheckboxItem({
	...
	return (
		<DropdownMenuPrimitive.CheckboxItem
			...
			className={cn(
				"relative flex cursor-default items-center gap-2",
				"rounded-sm py-1.5 pr-2 pl-8 text-sm outline-none select-none",
				"focus:bg-accent focus:text-accent-foreground",
				"data-disabled:pointer-events-none data-disabled:opacity-50",
				"[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
				className,
	...
	return (
		<DropdownMenuPrimitive.SubContent
			...
			className={cn(
				...
				"rounded-(--radius-md) border border-border p-1 shadow-lg",
				className,
			)}
			{...props}
		/>
