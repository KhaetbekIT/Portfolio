...
const roles = ["Фронтенд-разработчик", "Ментор", "Создатель продуктов"];
  ...
  return (
    <section className="relative flex min-h-[calc(100vh-73px)] items-center justify-center overflow-hidden px-4">
      ...
      <div className="relative mx-auto max-w-4xl text-center">
        ...
        >
          <span className="text-balance">{"Привет, я "}</span>
        ...
        >
          {"Я создаю доступные, пиксельно-точные цифровые решения для веба. С более чем 10-летним опытом я специализируюсь на построении масштабируемых фронтенд-архитектур и менторстве нового поколения разработчиков."}
        </motion.p>
